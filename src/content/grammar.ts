...
export const grammarTopics: GrammarTopic[] = [
  ...
  },
  {
    ...
    examples: [
      { de: "Ich wohne in Berlin.", translation: { ru: "Я живу в Берлине.", en: "I live in Berlin." } },
      { de: "Was machst du?", translation: { ru: "Что ты делаешь?", en: "What are you doing?" } },
      { de: "Wir lernen Deutsch.", translation: { ru: "Мы учим немецкий.", en: "We are learning German." } },
    ],
    tags: ["verbs"],
  },
  {
